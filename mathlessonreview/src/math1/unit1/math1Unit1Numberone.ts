 ...
 */
class math1Unit1Numberone extends math1Unit1{
    public constructor() {
        super();
        this.addEventListener(egret.Event.ADDED_TO_STAGE,this.addNumber,this);
    }
    //标志
    public typeSign:string;
    public scenIndex = 0;

    //初始化数据数组
    private basejsonarr:Array<any>=
        [{"lessonType":"math","lessonId":1,"unitId":1,"unitContent":[[
            {"data_type":"bitmap","data_name":"number1bg_png","data_key":"number1bg_png",
                ...
                {"data_type":"movieclip","data_json":"jump1_json","data_png":"jump1_png","data_name":"jump1","data_key":"jump1",
                    "data_frameLabel":[
                        ...
                        {"frameLabel":"@fallmove7","frameLabelEvent":function(currentObj){currentObj.x = currentObj.x-22;if(currentObj.x == 412){currentObj.gotoAndPlay("eye",1)}}}
                    ],
                ...
                {"data_type":"movieclip","data_json":"baozhaCould_json","data_png":"baozhaCould_png","data_name":"baozhaCould","data_key":"baozhaCould",
                    ...
                    "data_complete":function(e:egret.Event){
