 ...
 */
class english1Unit2Test extends englishfat implements interfaceenglish{
    constructor(){
        super();
    ...
    //人物数组
    private personarr:Array<createPerson>=[];
    //小相机
    private smallCamera;
    private word;
    private camerabig;
    //人物序号
    public personeindex = 0;
    //每个人物出错次数
    private sigelpersonwrong = 0;
    //人物名称的json
