 ...
 */
var english1Unit3Test = (function (_super) {
    __extends(english1Unit3Test, _super);
    function english1Unit3Test() {
        _super.call(this);
        this.sigletimutotalwrong = 0;
        //照片框数组
        this.picframearr = ["fense", "hongse", "lanse", "liuse", "qianliu", "ziluolan"];
        //照片框的坐标
        this.picframexyarr = [{ "x": 40, "y": 309 }, { "x": 80, "y": 111 }, { "x": 285, "y": 20 }, { "x": 494, "y": 20 },
            { "x": 697, "y": 111 }, { "x": 735, "y": 308 }];
        //单词照片
        this.wordandphotoarr = [{ "word": "daddy", "img": "baba" },
    ...
    var d = __define,c=english1Unit3Test,p=c.prototype;
    //添加图片
    p.addPhoto = function () {
    ...
    //判断是否拖到相框(标准是覆盖相框长宽的一半以上)
    p.isFit = function (dragimgobj, picframeobj) {
    ...
    //判断拖拽的对象是否符合标准
    p.isWordFit = function (name1, name2) {
        if (name1 == name2) {
            return true;
        }
        return false;
    ...
    return english1Unit3Test;
}(englishfat));
egret.registerClass(english1Unit3Test,'english1Unit3Test',["interfaceenglish"]);
