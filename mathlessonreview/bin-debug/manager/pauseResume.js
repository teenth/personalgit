 ...
 */
var pauseResume = (function (_super) {
    __extends(pauseResume, _super);
    function pauseResume() {
        _super.call(this);
        this.addEventListener(pauseResumeEvent.PAUSERESUME, this.changeState, this);
    }
    var d = __define,c=pauseResume,p=c.prototype;
    pauseResume.getInstance = function () {
...
egret.registerClass(pauseResume,'pauseResume');
