 ...
 */
var math1Unit2Numberone = (function (_super) {
    __extends(math1Unit2Numberone, _super);
    function math1Unit2Numberone() {
        _super.call(this);
        this.sigletimutotalwrong = 0;
        //铅笔每次向下移动的距离
        this.moveY = 50;
        //铅笔最终停留的位置坐标
        this.pendesx = egretUntil.getStageWidth() * 3 / 5;
        this.pendesy = egretUntil.getStageHeight() * 1 / 3;
        //铅笔在模型两边的偏移量
        this.penmodex = 20;
        //模型的宽高
        this.penmodheight = 0;
    ...
    var d = __define,c=math1Unit2Numberone,p=c.prototype;
    //添加场景
    ...
    p.penChangePosY = function () {
        if (this.pen.y < this.penmod.y + this.penmodheight) {
            ...
            egret.Tween.get(this.pen).to({ x: this.pendesx, y: this.pendesy }, 200).call(function () {
    ...
    return math1Unit2Numberone;
}(mathfat));
egret.registerClass(math1Unit2Numberone,'math1Unit2Numberone',["interfacemath"]);
