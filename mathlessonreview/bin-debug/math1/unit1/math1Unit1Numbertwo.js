 ...
 */
var math1Unit1Numbertwo = (function (_super) {
    __extends(math1Unit1Numbertwo, _super);
    function math1Unit1Numbertwo() {
        _super.call(this);
        //所有要暂停的缓动对象
        this.pauseTweenObjs = [];
        //添加背景图片
    ...
    var d = __define,c=math1Unit1Numbertwo,p=c.prototype;
    p.addBJ = function () {
    ...
    return math1Unit1Numbertwo;
}(mathfat));
egret.registerClass(math1Unit1Numbertwo,'math1Unit1Numbertwo');
